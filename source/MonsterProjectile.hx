...
class MonsterProjectile extends FlxSprite
{
	private static inline var MOVEMENT_SPEED:Float = 600;

	private var _target:FlxPoint;
	private var _type:MonsterProjectileType;
	 ...
	 */
	public function new(x:Float, y:Float, target:FlxPoint, type:MonsterProjectileType)
	{
		super(x, y);
		_target = target;
		_type = type;
	 ...
	 */
	public function getType():MonsterProjectileType
	{
		return _type;
	}
