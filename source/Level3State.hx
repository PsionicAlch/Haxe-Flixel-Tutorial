...
class Level3State extends FlxState
{
    ...
    override function create() 
    {
        ...
        _map = new FlxOgmo3Loader(AssetPaths.IntroductionToHaxeFlixel__ogmo, AssetPaths.level3Map__json);
    ...
    override function update(elapsed:Float) 
    {
        ...
        if (_player.health <= 0) FlxG.camera.fade(FlxColor.RED, 0.33, false, () -> FlxG.switchState(new DeathMenuState(new Level3State())));
        if (_amountOfMonsters <= 0) FlxG.camera.fade(FlxColor.GREEN, 0.33, false, () -> FlxG.switchState(new WinMenuState(new BossLevelState())));
